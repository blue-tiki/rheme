...
(test #f string->number "D")
(test 0+1i string->number "i")
(test 0+1i string->number "I")
(test 0+3i string->number "3i")
(test 0+3i string->number "3I")
(test 0+33i string->number "33i")
(test 0+33i string->number "33I")
(test 0+3.3i string->number "3.3i")
(test 0+3.3i string->number "3.3I")
(test #f string->number "-")
(test #f string->number "+")
...
(test #t call-with-input-file "r4rstest-rheme.scm" input-port?)
(define this-file (open-input-file "r4rstest-rheme.scm"))
